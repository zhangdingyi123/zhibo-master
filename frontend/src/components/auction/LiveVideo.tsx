...
export function LiveVideo({ title, coverUrl, viewerCount = 0 }: Props) {
  ...
  return (
    <div className="live-video">
      {coverUrl ? (
        <img className="live-video__cover live-video__cover--mock" src={coverUrl} alt="" />
      ) : (
        <div className="live-video__gradient live-video__gradient--mock" />
      )}
